...
from inference_models.models.base.object_detection import Detections, ObjectDetectionModel
...
class AIEForObjectDetection(
    ObjectDetectionModel[List[np.ndarray], List[PreProcessingMetadata], list],
):
    """AIE YOLO object detection model.

    Loads YOLO .pt or .nst weights trained with the AIE Training Toolkit.
